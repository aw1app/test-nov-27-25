...
//		// TASK-2: demo delete by id.
	...
	private static void connectToMongoDB() {
		...
		String cloudAtlasURL = "mongodb+srv://<username>:<password>@cluster0.ixxay.mongodb.net/?appName=Cluster0";
		...
		System.out.println("Successfully connected cloud atlas to products collection of cis_estore database");
	}
